...
public class Ecommerce extends Application {
    ...
    private void addItemsToCart(Product product) {
        ...
        else showDialogue("Please choose an item");
    }
    ...
    private GridPane footerBar() {
        ...
        placeOrderButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if (orderNumber > 0)
                    showDialogue("Your order for " + orderNumber + " items has been placed!");
        ...
        buyNowButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                else if(product == null && loggedInCustomer != null)showDialogue("Please select a product to place Order!!!");
                else showDialogue("Please Sign In to place an order!!!");
